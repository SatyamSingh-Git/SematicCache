Enhancements those can be done are categorized by **Algorithmic Improvements** (showing your AI depth) and **Software Engineering** (showing your production readiness).
